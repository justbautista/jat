            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="/" className="flex items-center mb-4 sm:mb-0">
                        <img src={JATlogo} className="mr-3 h-14" alt="devDirect Logo" />
                    </a>
                </div>
                <hr className="my-6 border-black sm:mx-auto lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-black sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:underline">JAT™</a> HackRU Project
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://github.com/justbautista/jat" className="text-black hover:text-gray-900">
