        ...
        <>
            ...
            <section className="flex flex-row justify-center mx-52 mb-24">
                <div className="flex flex-col section1size content-center">
                    <h1 className="text-4xl text-center mb-12 ">Changing the Application Game</h1>
                    ...
                    <div className="mx-24 mt-20">
                        <p className="p-3 text-lg  text-center mx-44 border-solid border-2 border-black"> JAT allows users to not only keep track of their job applications, but encourages them to apply to more job oppurtunities as well. Earn badges and keep your streak going day to day as you look for your new job oppurtunities.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="flex flex-row justify-center mx-52 mb-24 mt-24">
                <div className="flex flex-col section1size content-center">
                    <div className="flex flex-row">
                        ...
                        <img src={image1} alt="" className="rounded-full w-80 h-80 mr-8 ml-24" />
                    </div>
                </div>
            </section>
